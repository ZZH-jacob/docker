...
docker run -it --runtime=nvidia --name slr_m \
    --mount src=/home/v-zihanzheng/code/SceneLatent,target=/home/v-zihanzheng/code/SceneLatent,type=bind \
    -p 12345:22 \
    --ipc=host \
    zhzheng/slr:20240113 /bin/bash